...
CREATE TRIGGER IF NOT EXISTS delete_keys AFTER DELETE ON users FOR EACH ROW BEGIN
-- Delete user profile keys if the corresponding user profile is deleted. Since key
