...
// use aws_sigv4::{http_request, sign::v4};
use chrono::{DateTime, Duration, Utc};
use displaydoc::Display;
use phnxcommon::time::ExpirationData;
use phnxprotos::delivery_service::v1::{
    GetAttachmentPayload, GetAttachmentResponse, HeaderEntry, ProvisionAttachmentPayload,
