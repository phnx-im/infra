...
mixin _$AddMembersState {
  ...
  Set<UiUserId> get selectedContacts => throw _privateConstructorUsedError;
...
abstract class $AddMembersStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<UiContact> contacts, Set<UiUserId> selectedContacts});
}
...
class _$AddMembersStateImpl implements _AddMembersState {
  const _$AddMembersStateImpl({
    ...
    required final Set<UiUserId> selectedContacts,
  }) : _contacts = contacts,
  ...
  @override
  Set<UiUserId> get selectedContacts {
