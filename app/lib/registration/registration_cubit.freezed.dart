...
// Display name/avatar screen data
  ...
  @override
  int get hashCode => Object.hash(runtimeType, domain, username, password,
      isUsernameValid, isPasswordValid, avatar, displayName, isSigningUp);
...
abstract class _RegistrationState extends RegistrationState {
  const factory _RegistrationState(
      ...
      final ImageData? avatar,
      final String? displayName,
      final bool isSigningUp}) = _$RegistrationStateImpl;
