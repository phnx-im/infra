...
class _ListTileTop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Expanded(child: _convTitle(conversation.title)),
...
class _ListTileBottom extends StatelessWidget {
      ...
      children: [
        Expanded(
          child: Align(
            ...
            child: _lastMessage(context, conversation, userName),
          ),
        ),
        const SizedBox(width: 16),
        Align(
          alignment: Alignment.center,
          child: _unreadBadge(conversation),
        ),
      ],
    );
  }
  ...
  Widget _unreadBadge(UiConversationDetails conversation) {
    final count = conversation.unreadMessages;
    if (count < 1) {
...
Widget _convTitle(String title) {
  return Baseline(
    baseline: Spacings.s,
    baselineType: TextBaseline.alphabetic,
    child: Text(
