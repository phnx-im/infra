...
mixin _$HomeNavigationState {
  ...
  String? get memberDetails => throw _privateConstructorUsedError;
...
/// @nodoc
class _$HomeNavigationStateCopyWithImpl<$Res, $Val extends HomeNavigationState>
...
class _$NavigationState_IntroImpl extends NavigationState_Intro {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$NavigationState_IntroImpl &&
...
abstract class NavigationState_Intro extends NavigationState {
  const factory NavigationState_Intro({final List<IntroScreenType> screens}) =
      _$NavigationState_IntroImpl;
  const NavigationState_Intro._() : super._();
...
class __$$NavigationState_HomeImplCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $HomeNavigationStateCopyWith<$Res> get home {
    return $HomeNavigationStateCopyWith<$Res>(_value.home, (value) {
...
class _$NavigationState_HomeImpl extends NavigationState_Home {
  ...
  @override
  @JsonKey()
  final HomeNavigationState home;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$NavigationState_HomeImpl &&
...
abstract class NavigationState_Home extends NavigationState {
  const factory NavigationState_Home({final HomeNavigationState home}) =
      _$NavigationState_HomeImpl;
  const NavigationState_Home._() : super._();

  HomeNavigationState get home;
