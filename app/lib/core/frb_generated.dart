...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1305621815;
...
abstract class RustLibApi extends BaseApi {
  ...
  bool crateApiTypesUiConversationMessageIsHidden({
    required UiConversationMessage that,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  bool crateApiTypesUiConversationMessageIsHidden({
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_ui_conversation_message(that, serializer);
        ...
        constMeta: kCrateApiTypesUiConversationMessageIsHiddenConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiTypesUiConversationMessageIsHiddenConstMeta =>
      const TaskConstMeta(
        debugName: "ui_conversation_message_is_hidden",
        argNames: ["that"],
      );
