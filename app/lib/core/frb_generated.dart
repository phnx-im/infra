...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 228108560;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiNavigationCubitNavigationCubitBaseOpenIntroScreen(
      {required NavigationCubitBase that, required IntroScreenType screen});

  Future<void> crateApiNavigationCubitNavigationCubitBaseOpenMemberDetails(
      {required NavigationCubitBase that, required String member});
  ...
  NotificationService crateApiNotificationsNotificationServiceNew(
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_NotificationService;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_NotificationService;

  CrossPlatformFinalizerArg
      get rust_arc_decrement_strong_count_NotificationServicePtr;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerNotificationService(
            notificationService, serializer);
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_DartFn_Inputs__Output_list_notification_handle_AnyhowException(
            getActive, serializer);
        sse_encode_DartFn_Inputs_list_String_Output_unit_AnyhowException(
            remove, serializer);
      ...
      constMeta: kCrateApiNotificationsNotificationServiceNewConstMeta,
      argValues: [send, getActive, remove],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiNotificationsNotificationServiceNewConstMeta =>
      const TaskConstMeta(
        debugName: "NotificationService_new",
        argNames: ["send", "getActive", "remove"],
      );
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_list_String_Output_unit_AnyhowException(
          FutureOr<void> Function(List<String>) raw) {
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_NotificationService => wire
          .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerNotificationService;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_NotificationService => wire
  ...
  NotificationService
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerNotificationService(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return NotificationServiceImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  @protected
  FutureOr<void> Function(List<String>)
      dco_decode_DartFn_Inputs_list_String_Output_unit_AnyhowException(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError('');
  }
  ...
  NotificationService
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerNotificationService(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return NotificationServiceImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  HomeNavigationState sse_decode_home_navigation_state(
    ...
    return HomeNavigationState(
        ...
        userSettingsOpen: var_userSettingsOpen,
  ...
  NavigationState sse_decode_navigation_state(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 1:
        var var_home =
            sse_decode_box_autoadd_home_navigation_state(deserializer);
  ...
  NotificationHandle sse_decode_notification_handle(
    ...
    var var_conversationId = sse_decode_opt_String(deserializer);
    return NotificationHandle(
        identifier: var_identifier, conversationId: var_conversationId);
  }
  ...
  void
      sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerNavigationCubitBase(
          NavigationCubitBase self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as NotificationServiceImpl).frbInternalSseEncode(move: true),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as NotificationServiceImpl).frbInternalSseEncode(move: false),
        serializer);
  }
  ...
  @protected
  void sse_encode_DartFn_Inputs_list_String_Output_unit_AnyhowException(
      FutureOr<void> Function(List<String>) self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs_list_String_Output_unit_AnyhowException(self),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as NotificationServiceImpl).frbInternalSseEncode(move: null),
        serializer);
  }
  ...
  void sse_encode_StreamSink_navigation_state_Sse(
      RustStreamSink<NavigationState> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(
        self.setupAndSerialize(
            codec: SseCodec(
  ...
  void sse_encode_box_autoadd_developer_settings_screen_type(
      DeveloperSettingsScreenType self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_list_intro_screen_type(
      List<IntroScreenType> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
...
class NavigationCubitBaseImpl extends RustOpaque
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance.api.rust_arc_increment_strong_count_NavigationCubitBase,
    rustArcDecrementStrongCount: RustLib
        .instance.api.rust_arc_decrement_strong_count_NavigationCubitBase,
    rustArcDecrementStrongCountPtr: RustLib
        .instance.api.rust_arc_decrement_strong_count_NavigationCubitBasePtr,
  );

  Future<void> close() =>
      RustLib.instance.api.crateApiNavigationCubitNavigationCubitBaseClose(
        that: this,
      );

  Future<void> closeConversation() => RustLib.instance.api
          .crateApiNavigationCubitNavigationCubitBaseCloseConversation(
        that: this,
      );

  bool get isClosed =>
      RustLib.instance.api.crateApiNavigationCubitNavigationCubitBaseIsClosed(
        that: this,
      );

  Future<void> openAddMembers() => RustLib.instance.api
          .crateApiNavigationCubitNavigationCubitBaseOpenAddMembers(
        that: this,
      );
  ...
  Future<void> openConversation({required ConversationId conversationId}) =>
      RustLib.instance.api
          .crateApiNavigationCubitNavigationCubitBaseOpenConversation(
              that: this, conversationId: conversationId);
  ...
  Future<void> openDeveloperSettings(
      ...
      RustLib.instance.api
          .crateApiNavigationCubitNavigationCubitBaseOpenDeveloperSettings(
              that: this, screen: screen);

  Future<void> openHome() =>
      RustLib.instance.api.crateApiNavigationCubitNavigationCubitBaseOpenHome(
        that: this,
      );

  Future<void> openInto() =>
      RustLib.instance.api.crateApiNavigationCubitNavigationCubitBaseOpenInto(
        that: this,
      );
  ...
  Future<void> openMemberDetails({required String member}) =>
      RustLib.instance.api
          .crateApiNavigationCubitNavigationCubitBaseOpenMemberDetails(
              that: this, member: member);

  Future<void> openUserSettings() => RustLib.instance.api
          .crateApiNavigationCubitNavigationCubitBaseOpenUserSettings(
        that: this,
      );

  bool pop() =>
      RustLib.instance.api.crateApiNavigationCubitNavigationCubitBasePop(
        that: this,
      );

  NavigationState get state =>
      RustLib.instance.api.crateApiNavigationCubitNavigationCubitBaseState(
        that: this,
      );

  Stream<NavigationState> stream() =>
      RustLib.instance.api.crateApiNavigationCubitNavigationCubitBaseStream(
        that: this,
      );
}

@sealed
class NotificationServiceImpl extends RustOpaque
    implements NotificationService {
  // Not to be used by end users
  NotificationServiceImpl.frbInternalDcoDecode(List<dynamic> wire)
      : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  NotificationServiceImpl.frbInternalSseDecode(
      BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance.api.rust_arc_increment_strong_count_NotificationService,
    rustArcDecrementStrongCount: RustLib
        .instance.api.rust_arc_decrement_strong_count_NotificationService,
    rustArcDecrementStrongCountPtr: RustLib
        .instance.api.rust_arc_decrement_strong_count_NotificationServicePtr,
  );
}
