...
use crate::{
    ...
    messages::{
        AirProtocolVersion,
        connection_package_v2::{ConnectionPackageV2, ConnectionPackageV2In},
    },
...
impl VersionedConnectionPackage {
    ...
    pub fn into_v2(self) -> ConnectionPackageV2 {
        match self {
...
pub enum VersionedConnectionPackageIn {
    V1(ConnectionPackageIn),
    V2(ConnectionPackageV2In),
}
...
impl From<ConnectionPackageV2> for ConnectionPackage {
    fn from(v2: ConnectionPackageV2) -> Self {
